...
{
  // create book object with details specific to book object
...
{
  // create clothing object with details specific to clothing object
...
{
  // create movie object with details specific to movie object
